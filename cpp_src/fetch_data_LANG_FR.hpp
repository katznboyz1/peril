...
const std::string LANG_FR_DATA_VOCAB_NOUNS = "data.vocab_nouns.lang.fr.txt";
const std::string LANG_FR_DATA_VOCAB_ADJECTIVES = "data.vocab_adjectives.lang.fr.txt";
...
const std::string LANG_FR_DATA_VERB_VOCABULARY = "data.verb_vocabulary.lang.fr.txt";
